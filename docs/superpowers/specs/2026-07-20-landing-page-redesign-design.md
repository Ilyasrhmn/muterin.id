...
- Subheadline baru: **"Muterin mencatat jarak tempuh motormu dari sumber mana saja  manual, isi bensin, servis, atau riding  lalu otomatis mengingatkan kapan oli, ban, aki, atau servis rutin perlu diganti."**
...
3. **Muterin yang mantau**  "Status warna, skor kesehatan, dan Pusat Perhatian otomatis update, kamu tinggal cek kalau ada notifikasi."
...
3. **Muterin gratis?**  Gratis, tanpa kartu kredit, daftar langsung bisa dipakai.
...
- Baris bawah: wordmark "Muterin" besar (CSS `text-[clamp(3rem,15vw,10rem)] font-heading font-black text-primary/10`, bukan gambar, bukan animasi kompleks  cukup elemen statis besar sebagai penutup visual, konsisten dengan prinsip "no gradient, no template AI"  ini tipografi murni, bukan efek).
